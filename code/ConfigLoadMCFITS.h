...
namespace CTAConfig {
    ...
    public:
        ...
        struct CTAConfig::ConfigLoadMCFITS::Array *getArrayStruct();
        
        /// It gets the telescope structure from the identification number
        struct CTAConfig::ConfigLoadMCFITS::Telescope *getTelescopeStruct(int TelID);
        
        /// It gets the telescope type structure from the type identification number
        struct CTAConfig::ConfigLoadMCFITS::TelescopeType *getTelescopeTypeStruct(int TelType);
        
        /// It gets the mirror structure from the mirror type identification number
        struct CTAConfig::ConfigLoadMCFITS::MirrorType *getMirrorTypeStruct(int mirType);
        
        /// It gets the camera structure from the camera type identification number
        struct CTAConfig::ConfigLoadMCFITS::CameraType *getCameraTypeStruct(int camType);
        
        /// It gets the pixel structure from the pixel type identification number
        struct CTAConfig::ConfigLoadMCFITS::PixelType *getPixelTypeStruct(int pixType);

        /// It gets the pixel structure from the pixel type identification number
        struct CTAConfig::ConfigLoadMCFITS::Pixel *getPixelStruct(int camType, int pixelID);
